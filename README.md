...
Autopilot — фреймворк разработки, skill, который берёт вашу идею, задаёт 5–8 важных вопросов, а дальше сам пишет спецификацию, продумывает то, о чём вы не думали, разбивает работу на таски и собирает проект целиком. Вам не нужно читать спецификацию, оценивать таски или разбираться в коде.
