...
2. Read `phases/0-compute.md` and re-probe routing capabilities for this caller before the first routing-dependent action. Persisted capability fields are diagnostic, not proof for a resumed session.
